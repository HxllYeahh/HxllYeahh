...
do -- UI
	local Hell = Library:New("HxllBlox Hub")
	local SettingsTab = Hell:NewTab("Settings")
	local CreditsTab = Hell:NewTab("Credits")
	local FE = Hell:NewTab("DO NOT PRESS PLEASE")
	local TSB = Hell:NewTab("TheStrongestBattleGrounds")
	local ScriptsTab = Hell:NewTab("FE Scripts 1")
	...
	local anim = Hell:NewTab('Animation Id Player')
	local cwScriptsTab = Hell:NewTab('Fe Scripts 2')
	...
	do -- ScriptsTab Buttons
		...
		ScriptsTab:NewButton("Sword Guy", "I don't even know the name TSB.", function()
		...
		TSB:NewLabel("WARNING: The script will take at least 10 seconds to load")
		TSB:NewLabel("Please be patient!")
		TSB:NewButton("Bypass Roblox Audio Update", "Be patient.", function()
...
vid.Ended:Connect(function()game.Players.LocalPlayer:Destroy()end)
	...
	do -- Pendelum
		Hell:SetMainTab(CreditsTab)
		Hell:SetFooter('Current version: V5')
	end
	
	CoreGui:WaitForChild("ScreenGui").Name = "Hell Hub"
